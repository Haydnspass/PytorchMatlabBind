...
# In order to run this outside the standard location
  ...
  if(WIN32)
    ...
    if(APPLE)
      ...
      if(Matlab_HAS_CPP_API)
        ...
        set(_link_flags "${_link_flags} -Wl,-U,_mexCreateMexFunction -Wl,-U,_mexDestroyMexFunction -Wl,-U,_mexFunctionAdapter, -Wl,-U,_mexfilerequiredapiversion")
